...
def search_data(sequence_length, num_of_depend, label_start_idx,
    ...
    return x_idx[::-1]  #反转列别元素，使得时间序列从前往后排序
...
print('数据大小：',data['data'].shape)

all_data = read_and_generate_dataset(graph_signal_matrix_filename, 1, 1, num_of_hours, num_for_predict, points_per_hour=points_per_hour, save=True)
